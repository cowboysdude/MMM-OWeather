   ...
   Module.register("MMM-OWeather",{
      ...
      getDom: function() {
          ...
          if (!this.loaded) {
             ...
             wrapper.innerHTML = "Forecasting Weather...";
          ...
          var keys = Object.keys(this.weather.forecast);
           ...
           var today = moment().format('MM-DD-YYYY');
			...
			locationImg.classList.add("small","bright");
			...
			nextFive.classList.add("small","bright");
			...
			dateColumn.classList.add("small","bright","lowtemp");
	        dateColumn.innerHTML = weather.current_weather[0].temp + "&#730;";	
			} else if (weather.current_weather[0].temp > 85){
			dateColumn.classList.add("small","bright", "hitemp");
	        dateColumn.innerHTML = weather.current_weather[0].temp + "&#730;";	
			} else {
			dateColumn.classList.add("small","bright");
	        dateColumn.innerHTML = weather.current_weather[0].temp + "&#730;";	
			}
	        ...
	        highColumn.classList.add("small","bright", "humid");
			highColumn.innerHTML = weather.current_weather[0].humidity+"%";	
			} else {
			highColumn.classList.add("small","bright");
			highColumn.innerHTML = weather.current_weather[0].humidity+"%";	
			}
	        highColumn.innerHTML = weather.current_weather[0].humidity+"%";
			...
			lowColumn.classList.add("small", "bright");
